...
function run_case_study_A(path_to_result_csv::String; ipopt_lin_sol::String="mumps", tolerance::Float64=1e-5, set_rescaler::Int64 = 100)
    ...
    for i in 1:length(models)
        ...
        for criterion in criteria
            for ntw in 1:25 for fdr in 1:10
                ...
                pf_results = _PMD.solve_mc_pf(data, _PMD.IVRUPowerModel, se_solver)

                # Write measurements based on power flow
                _PMDSE.convert_rectangular_to_polar!(pf_results["solution"])
