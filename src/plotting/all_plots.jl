...
function plot_result_caseD(path_to_caseD_csv::String, which_plot::String)
    ...
    if which_plot == "error_ph1"
        Plots.scatter([x, x], [caseD.err_max_1, caseD.err_avg_1], markershape=[:circle :utriangle], label=["max. abs. error" "avg. abs. error"], ylabel="Absolute error ϵ [p.u.]", xlabel="Number of buses [-]", 
                legend=:bottomleft, title="Error plot for case study D - Phase 1", yscale=:log)
    elseif which_plot == "error_ph2"
        Plots.scatter([x, x], [caseD.err_max_2, caseD.err_avg_2], markershape=[:circle :utriangle], label=["max. abs. error" "avg. abs. error"], ylabel="Absolute error ϵ [p.u.]", xlabel="Number of buses [-]", 
                legend=:bottomleft, title="Error plot for case study D - Phase 2", yscale=:log)
    elseif which_plot == "error_ph3"
        Plots.scatter([x, x], [caseD.err_max_3, caseD.err_avg_3], markershape=[:circle :utriangle], label=["max. abs. error" "avg. abs. error"], ylabel="Absolute error ϵ [p.u.]", xlabel="Number of buses [-]", 
